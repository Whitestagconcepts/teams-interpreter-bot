#!/usr/bin/env python3
"""
Simple Teams Bot Server using Python's built-in http.server

This is a simplified version that supports the core translation functionality
without the complexity of the full Flask application.
"""
...
tts = None
try:
    # We use a dummy voice map since pyttsx3 uses system voices
    voice_map = {
        "en-US": "dummy",
        "ru-RU": "dummy",
        "es-CO": "dummy"
